...
export const getUserBalance = (address) => ({type: actionTypes.GET_PB_USER_BALANCE, address});
export const setUserBalance = (data) => ({type: actionTypes.SET_PB_USER_BALANCE, payload: data});

export const getLockedAssets = (address) => ({type: actionTypes.GET_PB_LOCKED_ASSETS, address});
export const setLockedAssets = (votingWeight, votingLockingEnd) => ({
    type: actionTypes.SET_PB_LOCKED_ASSETS,
    votingWeight: votingWeight,
    votingLockingEnd: votingLockingEnd
});
