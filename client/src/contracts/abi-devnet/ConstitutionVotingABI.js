...
export default [
  ...
  },
  {
    ...
    'outputs': [
      ...
      {
        'internalType': 'enum IParametersVoting.ParameterType',
        'name': 'parameterType',
        'type': 'uint8'
      },
      {
      ...
      },
      {
        ...
        'internalType': 'struct ConstitutionVoting.ParameterValue',
        'name': 'parameterValue',
        'type': 'tuple'
      },
      {
        'internalType': 'enum ConstitutionVoting.Classification',
        'name': 'classification',
        'type': 'uint8'
      },
      {
        'internalType': 'bytes32',
        'name': 'newConstitutionHash',
        'type': 'bytes32'
      },
      {
        'internalType': 'bytes32',
        'name': 'currentConstitutionHash',
        'type': 'bytes32'
      }
    ],
    'stateMutability': 'view',
