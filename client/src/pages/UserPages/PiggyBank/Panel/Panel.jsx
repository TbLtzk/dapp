...
export default function Panel() {
    ...
    return (
      <CustomBlockPanel>
          <TextPanel><span>Piggy Bank balance: </span><span>{userPBBalanceL}Q</span></TextPanel>
          <TextPanel><span>Q address balance: </span><span>{userBalanceL}Q</span></TextPanel>
          <TextPanel type={'parentNode'}>
              ...
              <TextPanelSmallBlack>{userVotingWeight}Q</TextPanelSmallBlack>
              <TextPanelSmallGrey style={{margin: '0 16px'}}>|</TextPanelSmallGrey>
              <TextPanelSmallGrey>Voting Locking End:</TextPanelSmallGrey>
              <TextPanelSmallBlack style={{margin: '0 16px 0 8px'}}>{userLockingEnd} UTC</TextPanelSmallBlack>
