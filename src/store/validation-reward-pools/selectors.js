...
export const poolInfoSelector = (state) => state.validationRewardPools.poolInfo
...
export const isStakerRewardPoolMsgDisplayed = (state) => state.validationRewardPools.isStakerRewardPoolMsgDisplayed
export const rewardPoolsBalanceSelector = (state) => state.validationRewardPools.rewardPoolsBalance
