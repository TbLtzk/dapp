    ...
    <PageLayout title={t('DATA_PRIVACY')}>
      <PolicyContainer>
        <CustomBlock>
          ...
          <h1>II. Data processing in general</h1>
          <h5>1. Scope of the processing of personal data</h5>
          <p>
          ...
          <h1>III. Description and scope of data processing</h1>
          <h5>1. Provision of the website</h5>
