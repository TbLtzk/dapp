export const rootSlashing = {
    subtitle: "Nominate a Root Node to be slashed",
    inputTitleDescr: ["Provide Slashing Details. Candidate to Slash", "Root Node Stake Amount to slash (%)"],
    inputs: ["Address", "%-Value"],
    inputsObj: {"address": '', "%-value": ''},
