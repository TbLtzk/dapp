...
import { Bus, NotificationObjectPayload } from 'utils/event-bus';

import 'react-toastify/dist/ReactToastify.css';
import './styles.css';

type NotificationTypeOptions = Exclude<TypeOptions, 'default'>;

export const NOTIFICATION_TYPE: Record<NotificationTypeOptions, NotificationTypeOptions> = {
  success: 'success',
  warning: 'warning',
  error: 'error',
  info: 'info',
...
const NotificationManager = () => {
  ...
  const showToast = useCallback(
    (
      messageType: NotificationTypeOptions,
