...
const Table = ({ tableBody, columns, perPage, keyField, search = true }) => (
  <TableContainer withPaganation={perPage < tableBody.length} search={search}>
    <PaginationProvider
      pagination={paginationFactory({
        custom: true,
        sizePerPage: perPage,
        totalSize: tableBody.length,
